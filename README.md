...
The clique won on the three most important components for the circuit to me (identifiability, locality, and richness). To explain where this structure lacked, its lower type and NT coherence scores were annotation artifacts as the dominant cell type (lLN1_bc) falls below the FlyWire NT classifier's confidence threshold for 23 of 38 neurons. At the Codex class level, 36 of 38 clique neurons are ALLN (Antennal Lobe Local Neurons) from the same ALl1_dorsal hemilineage, which leads to a type coherence of approximately 18/20.
